...
const routes = [
  ...
  {
    path: '/index/skill',
    redirect: '/index/skill/document_nav'
  },
  {
    path: '/index',
    name: 'Index',
    ...
    children: [
      {
        path: 'document_nav',
        name: 'document_nav',
        component: () => import('../views/skill/document/document_nav')
      },
      {
        path: 'document0_1',
        name: 'document0_1',
      ...
      },
      {
        path: 'document2',
        name: 'document2',
        component: () => import('../views/skill/document/document2')
      },
      {
        path: 'document3_1',
        name: 'document3_1',
      ...
      },
      {
        path: 'document11',
        name: 'document11',
        component: () => import('../views/skill/document/document11')
      },
      {
        path: 'document12',
        name: 'document12',
        component: () => import('../views/skill/document/document12')
      },
      {
        path: 'document13',
        name: 'document13',
        component: () => import('../views/skill/document/document13')
      }
    ]
  }
]
